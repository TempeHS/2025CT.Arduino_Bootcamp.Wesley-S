...
// Generally, you shuld use "unsigned long" for variables that hold time
// The value wil quickly become too large for an int to store
...
void loop() 
{
  // check to see if it's time to blind the LED; that is, if the difference 
  // between the current time and last time you blinked the LED is bigger than
  // the interval at which you want to blind the LED
